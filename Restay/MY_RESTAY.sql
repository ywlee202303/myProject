CREATE TABLE HOUSE_TEMP AS SELECT * FROM HOUSE;
...
CREATE TABLE "ROOM_IMAGE" (
	...
	"R_IMAGE_CODE"	VARCHAR2(30)		NOT NULL,
	"R_ORIGINAL_FILE"	VARCHAR2(4000)		NULL,
	"R_RENAME_FILE"	VARCHAR2(4000)		NULL
);

COMMENT ON COLUMN "ROOM_IMAGE"."R_NO" IS '방 번호';

COMMENT ON COLUMN "ROOM_IMAGE"."R_IMAGE_CODE" IS '방 이미지 코드';

COMMENT ON COLUMN "ROOM_IMAGE"."R_ORIGINAL_FILE" IS '원본파일명';

COMMENT ON COLUMN "ROOM_IMAGE"."R_RENAME_FILE" IS '변경파일명';
...
-- 숙소 테이블
CREATE TABLE "HOUSE" (
	"H_CODE"	VARCHAR2(30)		NOT NULL,
	"H_NAME"	VARCHAR2(30)		NULL,
	"H_ADDRESS"	VARCHAR2(100)		NULL,
	"H_TEL"	VARCHAR2(20)		NULL,
	"H_EMAIL"	VARCHAR2(50)		NULL,
	"H_AREA"	VARCHAR2(100)		NULL,
	"H_ENROLLDATE"	DATE		NULL,
	"H_STATUS"	VARCHAR2(3)		NULL,
	"H_SIGUNGU"	VARCHAR2(100)		NULL,
	"H_MIN_PRICE"	NUMBER		NULL
);

COMMENT ON COLUMN "HOUSE"."H_CODE" IS '숙소 코드';

COMMENT ON COLUMN "HOUSE"."H_NAME" IS '숙소 이름';

COMMENT ON COLUMN "HOUSE"."H_ADDRESS" IS '상세 주소';

COMMENT ON COLUMN "HOUSE"."H_TEL" IS '숙소전화번호';

COMMENT ON COLUMN "HOUSE"."H_EMAIL" IS '숙소 이메일';

COMMENT ON COLUMN "HOUSE"."H_AREA" IS '숙소 지역명';

COMMENT ON COLUMN "HOUSE"."H_ENROLLDATE" IS '숙소등록날짜';

COMMENT ON COLUMN "HOUSE"."H_STATUS" IS '숙소 상태';

COMMENT ON COLUMN "HOUSE"."H_SIGUNGU" IS '숙소 시군구';

COMMENT ON COLUMN "HOUSE"."H_MIN_PRICE" IS '숙소 최저 가격';
